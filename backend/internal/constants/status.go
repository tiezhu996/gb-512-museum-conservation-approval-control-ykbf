...
const (
	...
	ApprovalStateCorrection ApprovalState = "correction"
	ApprovalStateApproved   ApprovalState = "approved"
	ApprovalStateRejected   ApprovalState = "rejected"
)

var AllApprovalState = []string{"draft", "review", "correction", "approved", "rejected"}
...
var StageApprovalTransitions = map[string]map[string]bool{
	"draft":      {"review": true},
	"review":     {"approved": true, "rejected": true, "correction": true},
